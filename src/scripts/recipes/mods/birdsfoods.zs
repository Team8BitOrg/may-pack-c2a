...
//Remove By Recipe
recipes.removeByRecipeName("birdsfoods:apple_pie2");
recipes.removeByRecipeName("birdsfoods:rabbit_pie2");
recipes.removeByRecipeName("birdsfoods:chicken_pot_pie1");
recipes.removeByRecipeName("birdsfoods:shepherds_pie2");
recipes.removeByRecipeName("birdsfoods:fish_pie");
recipes.removeByRecipeName("birdsfoods:cottage_pie2");
recipes.removeByRecipeName("birdsfoods:veg_pie2");
recipes.removeByRecipeName("birdsfoods:veg_pie2");
